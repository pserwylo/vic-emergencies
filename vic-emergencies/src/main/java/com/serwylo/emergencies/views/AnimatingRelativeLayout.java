...
public class AnimatingRelativeLayout extends RelativeLayout
{
	...
	{
		inAnimation = (AnimationSet) AnimationUtils.loadAnimation(context, android.R.anim.slide_in_left);
		outAnimation = (Animation) AnimationUtils.loadAnimation(context, android.R.anim.slide_out_right);
	}
